...
-- The procedure described in the file 1.1.1/db.changelog-202603110003.sql
--  has been updated and included in this changelog.
-- ==========================================================================

--changeset liquibase:azureuser-202607290001-01 endDelimiter:GO
...
--changeset liquibase:azureuser-202607290001-02
GRANT EXECUTE
