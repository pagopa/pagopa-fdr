...
public enum AppErrorCodeMessageEnum {
  ...
  REPORTING_FLOW_PSP_ID_NOT_MATCH(
      "0704", "fdr.pspId.notMatch", RestResponse.Status.BAD_REQUEST, "-"),
  ...
  REPORTING_FLOW_WRONG_TOT_PAYMENT(
      "0723", "fdr.wrongTotPayment", RestResponse.Status.BAD_REQUEST, "-"),
  REPORTING_FLOW_WRONG_SUM_PAYMENT(
      "0724", "fdr.wrongSumPayment", RestResponse.Status.BAD_REQUEST, "-"),
  ...
  FILE_UTILS_CONVERSION_ERROR(
      "0729", "fdr.fileUtilsConversionError", Status.INTERNAL_SERVER_ERROR, "-"),
