...
public class AppConstantTestHelper {
  ...
  public static String PAYMENTS_ADD_TEMPLATE_2_PATH =
      Paths.get(TEST_UTIL_PATH, "payments-add-template-2.json").toString();

  // General template paths
  public static final String FLOW_TEMPLATE_WRONG_INSTANT_PATH =
      Paths.get(GENERAL_TEMPLATE_PATH, "flow-wrong-instant.json").toString();
  public static final String TEST_TEMPLATE_PATH =
      Paths.get(GENERAL_TEMPLATE_PATH, "test.json").toString();
  public static final String FLOW_TEMPLATE_WRONG_FIELDS_PATH =
      Paths.get(GENERAL_TEMPLATE_PATH, "flow-wrong-fields.json").toString();
  public static final String PAYMENTS_ADD_INVALID_FIELD_VALUE_TEMPLATE_PATH =
      Paths.get(GENERAL_TEMPLATE_PATH, "payments-add-invalid-value.json").toString();

  public static final String MALFORMED_JSON_PATH =
      Paths.get(GENERAL_TEMPLATE_PATH, "malformed.json").toString();
  public static final String PAYMENTS_DELETE_WRONG_TEMPLATE_PATH =
      Paths.get(GENERAL_TEMPLATE_PATH, "payments-delete-wrong-format.json").toString();
  public static final String PAYMENTS_SAME_INDEX_ADD_TEMPLATE_PATH =
      Paths.get(GENERAL_TEMPLATE_PATH, "payments-add-same-index.json").toString();
  public static final String PAYMENTS_2_ADD_TEMPLATE_PATH =
      Paths.get(GENERAL_TEMPLATE_PATH, "payments-add.json").toString();

  public static final String PAYMENTS_ADD_INVALID_FORMAT_VALUE_TEMPLATE_PATH =
      Paths.get(GENERAL_TEMPLATE_PATH, "payments-add-invalid-format-value.json").toString();

  public static final String PAYMENTS_ADD_INVALID_FORMAT_TEMPLATE_PATH =
      Paths.get(GENERAL_TEMPLATE_PATH, "payments-add-invalid-format.json").toString();

  public static final String PAYMENTS_DELETE_SAME_INDEX_TEMPLATE_PATH =
      Paths.get(GENERAL_TEMPLATE_PATH, "payments-delete-same-index.json").toString();
  ...
  public static final String INTERNAL_OPERATION_PAYMENTS_DELETE_TEMPLATE_PATH =
      Paths.get(INTERNAL_OPERATION_TEMPLATE_PATH, "payments-delete.json").toString();
  ...
  public static final String PSP_PAYMENTS_DELETE_TEMPLATE_PATH =
      Paths.get(PSP_TEMPLATE_PATH, "payments-delete.json").toString();
}
