...
//    String responseFmt =
//        """
//        {"httpStatusCode":400,"httpStatusDescription":"Bad
// Request","appErrorCode":"FDR-0704","errors":[{"message":"Reporting flow
// [2016-08-16pspLorenz-1176] have sender.pspId [PSP_NOT_MATCH] but not match with query param
// [pspLorenz]"}]}""";
//
//    given()
//        .body(bodyFmt)
...
//        """
//        {"httpStatusCode":400,"httpStatusDescription":"Bad
// Request","appErrorCode":"FDR-0708","errors":[{"message":"Psp [PSP_UNKNOWN] unknown"}]}""";
//
//    given()
//        .body(bodyFmt)
//        .header(header)
...
//        """
//        {"httpStatusCode":400,"httpStatusDescription":"Bad
// Request","appErrorCode":"FDR-0709","errors":[{"message":"Psp [pspNotEnabled] not enabled"}]}""";
//
//    given()
//        .body(bodyFmt)
//        .header(header)
