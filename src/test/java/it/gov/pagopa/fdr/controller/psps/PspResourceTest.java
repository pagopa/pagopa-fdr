...
class PspResourceTest {
  ...
  void test_psp_deleteFlow_OK() {
    ...
    assertThat(resDelError.getAppErrorCode(),
        equalTo(AppErrorCodeMessageEnum.REPORTING_FLOW_NOT_FOUND.errorCode()));
    assertThat(resDelError.getErrors(),
  ...
  void test_psp_deletePayments_OK() {
    ...
    assertThat(resDelError.getErrors(), hasItem(hasProperty("message", equalTo(
        String.format("Index of payment not match with index loaded on fdr [%s]", flowName)))));
  }
  ...
  void test_psp_publish_KO_FDR0701() {
    ...
    assertThat(resDelError.getAppErrorCode(),
        equalTo(AppErrorCodeMessageEnum.REPORTING_FLOW_NOT_FOUND.errorCode()));
    assertThat(resDelError.getErrors(), hasItem(
  ...
  void test_psp_KO_FDR0702() {
    ...
    assertThat(resDelError.getErrors(), hasItem(hasProperty("message",
  ...
  void test_psp_CREATED_publish_KO_FDR0703() {
    ...
    ErrorResponse resPublish = given()
        ...
        .extract()
        .as(ErrorResponse.class);
    assertThat(resPublish.getAppErrorCode(),
        equalTo(AppErrorCodeMessageEnum.REPORTING_FLOW_WRONG_ACTION.errorCode()));
    assertThat(resPublish.getErrors(), hasItem(hasProperty("message",
  ...
  void test_psp_KO_FDR0704() {
    ...
    assertThat(resDelError.getErrors(), hasItem(hasProperty("message", equalTo(
        String.format("Fdr [%s] have sender.pspId [%s] but not match with query param [%s]",
  ...
  void test_psp_payments_add_KO_FDR0705() {
    ...
    ErrorResponse resDelError = given()
        ...
        .extract()
        .as(ErrorResponse.class);
    assertThat(resDelError.getAppErrorCode(), equalTo(
        AppErrorCodeMessageEnum.REPORTING_FLOW_PAYMENT_SAME_INDEX_IN_SAME_REQUEST.errorCode()));
    assertThat(resDelError.getErrors(), hasItem(hasProperty("message", equalTo(
        String.format("Exist one or more payment index in same request on fdr [%s]", flowName)))));
  }
  ...
  void test_psp_KO_FDR0706() {
    ...
    ErrorResponse resSavePays2 = given()
        ...
        .extract()
        .as(ErrorResponse.class);
    assertThat(resSavePays2.getAppErrorCode(),
        equalTo(AppErrorCodeMessageEnum.REPORTING_FLOW_PAYMENT_DUPLICATE_INDEX.errorCode()));
    assertThat(resSavePays2.getErrors(), hasItem(hasProperty("message",
        equalTo(String.format("One or more payment index already added on fdr [%s]", flowName)))));
  }
  ...
  void test_psp_KO_FDR0709() {
    ...
    assertThat(res.getErrors(), hasItem(hasProperty("message",
        equalTo(String.format("Psp [%s] not enabled", PSP_CODE_NOT_ENABLED)))));
  }
  ...
  void test_brokerpsp_KO_FDR0710() {
    ...
    ErrorResponse resDelError = given()
        ...
        .as(ErrorResponse.class);
    assertThat(resDelError.getAppErrorCode(),
        equalTo(AppErrorCodeMessageEnum.BROKER_UNKNOWN.errorCode()));
    assertThat(resDelError.getErrors(), hasItem(
        hasProperty("message", equalTo(String.format("Broker [%s] unknown", brokerPspUnknown)))));
  }
  ...
  void test_brokerpsp_KO_FDR0711() {
    ...
    assertThat(res.getAppErrorCode(),
        equalTo(AppErrorCodeMessageEnum.BROKER_NOT_ENABLED.errorCode()));
    assertThat(res.getErrors(), hasItem(hasProperty("message",
  ...
  void test_channel_KO_FDR0712() {
    ...
    assertThat(res.getErrors(), hasItem(
        hasProperty("message", equalTo(String.format("Channel [%s] unknown", channelUnknown)))));
  }
  ...
  void test_channel_KO_FDR0713() {
    ...
    ErrorResponse res = given()
        ...
        .as(ErrorResponse.class);
    assertThat(res.getAppErrorCode(),
        equalTo(AppErrorCodeMessageEnum.CHANNEL_NOT_ENABLED.errorCode()));
  ...
  void test_channelBroker_KO_FDR0714() {
    ...
    assertThat(res.getErrors(), hasItem(hasProperty("message", equalTo(
        String.format("Channel [%s] with broker [%s] not authorized", CHANNEL_CODE,
            BROKER_CODE_2)))));
  }
  ...
  void test_channelPsp_KO_FDR0715() {
    ...
    assertThat(res.getErrors(), hasItem(hasProperty("message", equalTo(
        String.format("Channel [%s] with psp [%s] not authorized", CHANNEL_CODE, PSP_CODE_2)))));
  }
  ...
  void test_ecId_KO_FDR0717() {
    ...
    assertThat(res.getErrors(), hasItem(hasProperty("message",
        equalTo(String.format("Creditor institution [%s] not enabled", EC_CODE_NOT_ENABLED)))));
  }
  ...
  void test_psp_KO_FDR0401() {
    ...
    ErrorResponse res = given()
        ...
        .as(ErrorResponse.class);
    assertThat(res.getAppErrorCode(),
        equalTo(AppErrorCodeMessageEnum.BAD_REQUEST_INPUT_JSON.errorCode()));
    assertThat(res.getErrors(), hasItem(hasProperty("message", equalTo(
        String.format("Bad request. Field [payments.pay] is [%s]. Not match a correct value",
            wrongFormatDecimal)))));
  }
  ...
  void test_psp_KO_FDR0402() {
    ...
    assertThat(res.getErrors(), hasItem(hasProperty("message", equalTo(String.format(
        "Bad request. Field [fdrDate] is [%s]. Expected ISO-8601 [2011-12-03T10:15:30Z] [2023-04-05T09:21:37.810000Z]",
        wrongFormatDate)))));
  }
  ...
  void test_psp_KO_FDR0403() {
    ...
    assertThat(res.getErrors(), hasItem(hasProperty("message", equalTo(String.format(
        "Bad request. Field [sender.type] is [%s]. Expected value one of [LEGAL_PERSON, ABI_CODE, BIC_CODE]",
        wrongEnum)))));
  }
  ...
  void test_psp_KO_FDR0404() {
    ...
    assertThat(resDelError.getErrors(), hasItem(hasProperty("message", equalTo(
        "Bad request. Field [payments] generate an deserialize error. Set correct value"))));
  }
